...
The \emph{Terras map} $T : \mathbb{O} \to \mathbb{Z}^+$~\cite{terras1976} folds the
mandatory halving into the odd step:
\[
  T(n) \;=\; \frac{3n+1}{2}, \qquad n \in \mathbb{O}.
\]
Note that $T(n)$ is not generally odd; the Terras map steps from odd integer to
