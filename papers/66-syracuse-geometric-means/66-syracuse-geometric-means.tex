...
The full Steiner language hierarchy — alphabet, letters, words, sentences, volumes,
and libraries — is defined in Appendix~A of Paper~67~\cite{paper67}.
...
The Steiner language hierarchy — alphabet, letters, words, sentences, volumes,
and libraries — is defined in full in Appendix~A of Paper~67~\cite{paper67}.
